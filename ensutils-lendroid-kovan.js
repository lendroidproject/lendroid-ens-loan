...
//ropsten
//var ens = ensContract.at('0xb766772c58b098d8412143a473aed6bc41c95bde');
// kovan
var ens = ensContract.at('0xdE52AE305894282Ca2FF776eF7f2a926650ff35A');
...
var ethRegistrar = auctionRegistrarContract.at(ens.owner(namehash('test')));
...
var testRegistrar = fifsRegistrarContract.at(ens.owner(namehash('fifstest')));
...
//ens.setOwner(0, '0x75d2e5c4317ca5fd600d2502b141ed763406b390', {from: web3.eth.accounts[0]});
