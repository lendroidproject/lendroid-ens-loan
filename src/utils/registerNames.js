...
console.log(new Date(testRegistrar.expiryTimes(web3.sha3('lendroid')).toNumber() * 1000));
console.log(testRegistrar.register(web3.sha3('lendroid'), address, {from: address}));
