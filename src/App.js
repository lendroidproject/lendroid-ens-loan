    ...
    this.state.web3.eth.getAccounts((error, accounts) => {
      ...
      var ens = ensContract.new({
          ...
          if (typeof contract.address !== 'undefined') {
              // Save ens contract to state
              _that.setState({
                ens: ens,
                ENSRootAddress: contract.address
              });
              // Regitrar contract
              ...
              var registrar = registrarContract.new(
                  ...
                  if (typeof contract.address !== 'undefined') {
                      ...
                      _that.state.ens.setOwner(0, registrar.address, {from: _that.state.userAccount});
                      registrar.register(_that.state.web3.sha3(_that.state.ensName1), _that.state.userAccount, {from: _that.state.userAccount});
                  }
              });
          }
      });
